...
public:
  ...
  static std::string warn() { return std::string("\e[31m[WARN] \e[39m"); }
  static std::string info() { return std::string("\e[32m[INFO] \e[39m"); }
  static std::string tool() { return std::string("\e[33m[TOOL] \e[39m"); }
  static std::string idnt() { return std::string("       "); }
